...
async function Create(e) {
    ...
    try {
        ...
        if (res.ok) {
            success = "Compte créer avec succès, veuillez vous connecter"
            window.location.href = "/login?success=" + encodeURIComponent(success);
        } else {
        ...
        window.location.href = "/create?error=Serveur indisponible";
    }
}